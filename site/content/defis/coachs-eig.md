---
title: Coachs EIG
description: Faciliter la collaboration et l'innovation au sein de l'écosystème du numérique public 
...
## Les porteurs et porteuses de projet des équipes EIG manifestent leur appétence pour un appui méthodologique renforcé{.title}
...
## Le renforcement du dispositif d'accompagnement des administrations permettrait de faciliter la relève des défis et la pérennisation des EIG{.title}
...
## Faciliter la collaboration et l'innovation au sein de l'écosystème du numérique public{.title}
...
* Corine Waroquiers, responsable du programme Entrepreneurs d'intérêt Général

#### Les EIG recherché(e)s
* Coach technique et/ou data
* Coach design et/ou produit